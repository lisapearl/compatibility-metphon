...
parser.add_argument("file", help="The name of the Brent data file used for either the OT\ or the parametric systems. Usually called condensed.txt")

args = parser.parse_args()



upperboundFile = open("upperbound.txt", "w")

sys.stdout = upperboundFile
