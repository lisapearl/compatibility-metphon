...
## input expected (ex: compatibility_noinfl_afterTP.txt in Hayes or HV)
...
## or for OT: grammars.eval.brent_afterTP_noinfl.txt
...
## Usage
# make_rel_comp_classes.pl --compatibility_file compatibility_noinfl_afterTP.txt
# make_rel_comp_classes.pl --grammars.eval.brent_afterTP_noinfl.txt compatibility_noinfl_afterTP.txt --OT
